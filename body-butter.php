...
<html lang="en">
    ...
    <body>
        ...
        <div class="grid-container">
            <div class="product">
                <img class="pic" src="/skincare/img/butter2.jpg" alt="Body Butter 2">
                <div class="prod-info">
            ...
            <div class="product">
                <img class="pic" src="/skincare/img/butter3.jpg" alt="Body Butter 3">
                <div class="prod-info">
            ...
            <div class="product">
                <img class="pic"src="/skincare/img/butter4.jpg" alt="Body Butter 4">
                <div class="prod-info">
            ...
            <div class="product">
                <img class="pic" src="/skincare/img/butter6.jpg" alt="Body Butter 6">
                <div class="prod-info">
